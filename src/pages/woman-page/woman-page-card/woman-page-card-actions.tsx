...
import { createModifyCartItemAction } from '../../../store/woman-action-creator';
...
const WomanPageCardActions: React.FC<ShopPageCardActionsProps> = ({
  id,
  inStock,
}) => {
...
export default WomanPageCardActions;

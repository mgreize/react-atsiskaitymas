...
import { shopClearErrorAction, shopFetchItemsAction } from '../../store/woman-action-creator';
import WomanPageCard from './woman-page-card';
...
const WomanPage: React.FC = () => {
  ...
  return (
    <Box sx={{ bgcolor: 'grey.300', minHeight: 700 }}>
      <Container>
        <Typography component="h1" variant="h2" sx={{ py: 3, textAlign: 'center' }}>Ladies watches</Typography>
        {error && (

...
import { createModifyCartItemAction } from '../../../store/man-action-creator';
...
const ManPageCardActions: React.FC<ShopPageCardActionsProps> = ({
  id,
  inStock,
}) => {
...
export default ManPageCardActions;

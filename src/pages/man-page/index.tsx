...
import { shopClearErrorAction, shopFetchItemsAction } from '../../store/man-action-creator';
import WomanPageCard from './man-page-card';
...
const ManPage: React.FC = () => {
  ...
  return (
    <Box sx={{ bgcolor: 'grey.300', minHeight: 700 }}>
      <Container>
        <Typography component="h1" variant="h2" sx={{ py: 3, textAlign: 'center' }}>Mens watches</Typography>
        {error && (
